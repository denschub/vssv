...
But if you have to, there is a container image [in the GitHub Container registry at `ghcr.io/skyschub/vssv:latest`](https://github.com/skyschub/vssv/pkgs/container/vssv), and [on Docker Hub as `skyschub/vssv:latest`](https://hub.docker.com/repository/docker/skyschub/vssv/general). The container exposes port 8081.
